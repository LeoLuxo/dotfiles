...
menu(where=@(this.count == 0) type='taskbar' image=icon.settings expanded=true)
{
	menu(title="Apps" image=\uE254)
	{
		...
		// item(title='Start11' image cmd='C:\Program Files (x86)\Stardock\Start11\Start11Config.exe')
		...
		// item(title='StartAllBack' image cmd='C:\Users\pollux\AppData\Local\StartAllBack\StartAllBackCfg.exe')
	}
